...
from hurumap.data.base import Base
from hurumap.data.utils import get_session, capitalize, percent as p, add_metadata
...
class SimpleTable(object):
    ...
    def __init__(self, id, universe, description, model='auto', total_column='total',
        ...
        :param str total_column: the name of the column that represents the total value
                                 of all the columns in the row. This allows HURUmap to express
