...
from hurumap.profiles import enhance_api_data
from hurumap.data.tables import get_datatable, DATA_TABLES
from hurumap.data.utils import LocationNotFound
from hurumap.data.download import DownloadManager
...
class HomepageView(TemplateView):
    ...
    def get_context_data(self, *args, **kwargs):
        return {
            ...
            'topics': dict(settings.HURUMAP.get('topics', {}))
        }
...
class GeographyDetailView(BaseGeographyDetailView):
    ...
    def get_context_data(self, *args, **kwargs):
        ...
        if not profile_method:
            raise ValueError("You must define HURUMAP.profile_builder in settings.py")
